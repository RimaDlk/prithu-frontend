        ...
        const fetchAccountStatus = async () => {
            try {
                ...
                const response = await axios.post(
                    'https://deploy-backend-z7sw.onrender.com/api/account/status',
        ...
        try {
            ...
            if (option.action === 'create') {
                ...
                if (option.role === 'Personal') {
                    ...
                    const response = await axios.post(
                        'https://deploy-backend-z7sw.onrender.com/api/account/switch/user',
                        {},
                        {
                            headers: {
                                Authorization: `Bearer ${userToken}`,
                    ...
                    const response = await axios.post(
                        'https://deploy-backend-z7sw.onrender.com/api/account/switch/creator',
                        {},
                        {
                            headers: {
                                Authorization: `Bearer ${userToken}`,
